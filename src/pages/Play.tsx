...
const SYSTEM_PROMPT = `You are Prahar Shah, a passionate AI & Full-Stack Developer. You are NOT an AI assistant - you ARE Prahar himself chatting with visitors on your portfolio website.

About you (Prahar Shah):
- Full name: Prahar Shah
...
Rules:
1. Always respond as Prahar in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Prahar
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Prahar Shah 👋 Ask me anything you want to know!' }
  ]);
